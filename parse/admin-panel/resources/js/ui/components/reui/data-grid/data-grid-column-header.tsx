...
function DataGridColumnHeaderInner<TData, TValue>({
    ...
    const canRemoveSorting = table.options.enableSortingRemoval !== false;
        ...
        if (canSort) {
            ...
            items.push(
                <DropdownMenuItem
                    key="sort-asc"
                    onClick={() => {
                        if (isSorted === 'asc' && canRemoveSorting) {
                            column.clearSorting();
                ...
                <DropdownMenuItem
                    key="sort-desc"
                    onClick={() => {
                        if (isSorted === 'desc' && canRemoveSorting) {
                            column.clearSorting();
                        } else if (isSorted !== 'desc') {
                            column.toggleSorting(true);
                        }
                ...
                <DropdownMenuItem
                    ...
                    onClick={() => {
                        if (columnIndex > 0) {
                            ...
                            const [movedColumn] = newOrder.splice(
                                columnIndex,
                                1,
                            );
