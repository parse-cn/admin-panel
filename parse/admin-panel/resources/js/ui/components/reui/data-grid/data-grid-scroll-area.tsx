...
function DataGridScrollArea({
    ...
    const scrollbarInsetStart = isColumnsPinnable
    ...
    const resetMetrics = useCallback(() => {
        ...
        if (
            container &&
            !areMetricsEqual(INITIAL_METRICS, metricsRef.current)
        ) {
    ...
    const syncCustomVerticalScrollbar = useCallback(() => {
        ...
        if (trackHeight === 0 || maxScroll === 0) {
            ...
            const thumbTop =
                maxThumbTop > 0
                    ? (viewport.scrollTop / maxScroll) * maxThumbTop
                    : 0;
                    ...
                    <ScrollAreaPrimitive.Scrollbar
                        ...
                        style={
                            scrollbarInsetStart > 0 || scrollbarInsetEnd > 0
                                ? {
                                      marginInlineStart:
                                          scrollbarInsetStart || undefined,
                                      marginInlineEnd:
                                          scrollbarInsetEnd || undefined,
                                  }
                                : undefined
                        }
                    >
