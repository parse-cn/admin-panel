...
export function CrudWidget({
  ...
  const { data, hasError, processing, refresh } = useCrudData(dataUrl, context);
      ...
      <DataGridView
        ...
        records={{
          ...
          data: data.records.data.map((record) => ({
            ...
            routes: {
              ...record.routes,
              edit: definition.permissions?.update ? record.routes.edit : null,
        ...
        routes={{
          ...data.routes,
          create: definition.permissions?.create ? data.routes.create : null,
        }}
        callbacks={{
        ...
        showFilters={config.showFilters ?? definition.showFilters ?? false}
        ...
        enableSelection={
          ...
          (config.showBulkActions ?? definition.showBulkActions ?? true)
        }
      />
      ...
      >
        {recordToDelete && (
          <DeleteRecordDialogContent
            ...
            recordName={String(
              recordToDelete.values.name ?? definition.singularLabel,
            )}
