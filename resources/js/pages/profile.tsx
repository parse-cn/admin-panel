          ...
          <div className={activeTab === 'profile' ? '' : 'hidden'}>
            <Frame>
              <FrameHeader>
                ...
                <FrameDescription>{translations.description}</FrameDescription>
              </FrameHeader>
                  ...
                  <>
                    <FramePanel className="p-0">
                      <FieldGroup className="gap-0">
                        <Field orientation="responsive" className="px-5 py-4">
                          <FieldContent>
                            <FieldLabel>{translations.avatar}</FieldLabel>
                          </FieldContent>
                          <div className="flex min-w-0 flex-1 flex-wrap items-center gap-3">
                            <Avatar className="size-12 border">
                              <AvatarImage
                                src={avatarPreview ?? undefined}
                                alt={auth.user.name ?? translations.avatar}
                              />
                              <AvatarFallback>
                                {(auth.user.name ?? 'M')
                                  .slice(0, 1)
                    ...
                    <FrameFooter className="flex justify-end">
                      <Button
                        ...
                        disabled={processing || avatarUpload.processing}
                      >
                        {translations.save}
                      </Button>
                    </FrameFooter>
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <AccountSettingSection
        title="General"
        items={[
          ['Default view', 'Choose which layout opens when you sign in.'],
          ['Date format', 'How dates appear across the admin.'],
          ['First day of week', 'Used by calendars and date pickers.'],
          ['Auto-save drafts', 'Keep unsaved edits as you work.'],
          ['Rich text editing', 'Show the formatting toolbar in text fields.'],
        ]}
      />
      <AccountSettingSection
        title="Display"
        items={[
          ['Color theme', 'Applies everywhere, including the sidebar toggle.'],
          ['Sidebar position', 'Place the navigation on either side.'],
          ['Reduce animations', 'Minimize motion across the interface.'],
    ...
    <div className="flex w-full flex-col gap-4">
      <AccountSettingSection
        ...
        items={[
          ...
          ['Active sessions', 'Review the devices currently signed in.'],
        ]}
