      ...
      <Frame spacing="sm">
        ...
        <FramePanel className="p-0">
          <div className="divide-y">
            ...
            />
            <SecurityRow label={t('account.google_authenticator')} />
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        >
          <SheetHeader className="shrink-0 border-b px-5 py-4 pr-16 sm:px-6">
            <SheetTitle>{t('account.change_password_title')}</SheetTitle>
            <SheetDescription>
      ...
      <InputGroup>
        ...
        <InputGroupAddon align="inline-end">
          <InputGroupButton
            ...
            size="icon-xs"
            aria-label={
              visible ? t('account.hide_password') : t('account.show_password')
            }
